...
export default function Header(){
    ...
    return(
        <header className="flex flex-col font-sans gap-2">
            ...
            <ul className={`bg-black/20 transition-all duration-300 ease-in-out ${
            ...
            {headerMenu.map((item, index) => (
                <li key={index}>
                    <a 
                        href={item.uri} 
                        className="!text-white !no-underline py-4 px-4 block hover:bg-black/20 active:bg-black/20"
